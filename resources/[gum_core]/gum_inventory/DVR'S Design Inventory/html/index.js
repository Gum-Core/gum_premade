...
function loadTableData(table_inv, money, wtable_inv, gold) {
    ...
    let dataHtml = '';
    dataHtml += '<div class="item" data-content="money"><div id="money" class="item-content" " onMouseOver="change_name(-1)"  ondblclick="UseItem(money)"><img src="images/items/money.png" width="90" height="90"  id="item"><div class="bottom-right" id="count_money">'+Math.round(money * 100)/100+'$</div></div></div>'
    dataHtml += '<div class="item" data-content="gold"><div id="gold" class="item-content" " onMouseOver="change_name(-2)"  ondblclick="UseItem(gold)"><img src="images/items/gold.png" width="90" height="90"  id="item"><div class="bottom-right" id="count_gold">'+Math.round(gold * 100)/100+'</div></div></div>'
    count_inventory = 0
    count_winventory = 0
    for (var i in table_inv) {
        ...
        if (durabilityValue !== 0) {
            dataHtml += '<div class="item" data-content="'+table_inv[i].category+'"><div id="'+ i +'" class="item-content" onMouseOver="change_name('+ i +')" ondblclick="UseItem('+i+')"><img src="images/items/' + table_inv[i].item + '.png" width="90" height="90"  id="item"><progress id="progress" max="100" value="'+durabilityValue+'">TEST</progress><div class="bottom-right" id="count_'+i+'">' + table_inv[i].count + '</br>'+Math.round(weight_item*100)/100+'kg</div></div></div>'
        } else {
            var image_url = 'nui://gum_inventory/html/images/items/' + table_inv[i].item + '.png';
            if (doesFileExist(image_url) == "yes") {
                dataHtml += '<div class="item"  data-content="'+table_inv[i].category+'"><div id="'+ i +'" class="item-content" onMouseOver="change_name('+ i +')" ondblclick="UseItem('+i+')"><img src="images/items/' + table_inv[i].item + '.png" width="90" height="90"  id="item"><div class="bottom-right" id="count_'+i+'">' + table_inv[i].count + '</br>'+Math.round(weight_item*100)/100+'kg</div></div></div>'
            } else {
                dataHtml += '<div class="item"  data-content="'+table_inv[i].category+'"><div id="'+ i +'" class="item-content" onMouseOver="change_name('+ i +')" ondblclick="UseItem('+i+')"><img src="images/items/badItem.png" width="90" height="90"  id="item"><div class="bottom-right" id="count_'+i+'">' + table_inv[i].count + '</br>'+Math.round(weight_item*100)/100+'kg</div></div></div>'
            }
    ...
    for (var i in wtable_inv) {
        ...
        dataHtml += '<div class="item" data-content="weapon"><div id="'+ i +'" class="item-content" onMouseOver="change_name_wep('+ i +')"  ondblclick="UseWeapon(\''+wtable_inv[i].id+'\',\''+wtable_inv[i].name+'\')"><img src="images/items/' + wtable_inv[i].name + '.png" width="90" height="90"  id="weapon"><div class="bottom-right" id="count_'+i+'"></div></div></div>'
    }
...
function loadstoragedata(strg_dt) {
    ...
    for (var i in strg_dt) {
        if (strg_dt[i].weapon == false & strg_dt[i].item === 'money' & strg_dt[i].item !== 'gold') {
            ...
            data_storage_Html += '<div class="item" data-content="'+strg_dt[i].label+'"><div id="'+ i +'" class="item-content" ondblclick="transfer_from_storage()" onMouseOver="change_name_other('+ i +')" ><img src="images/items/' + strg_dt[i].item + '.png" width="90" height="90"  id="item"><div class="bottom-right" id="count_'+i+'">' + strg_dt[i].count + '</div></div></div>'
        }
    }
    ...
    for (var i in strg_dt) {
        if (strg_dt[i].weapon == false & strg_dt[i].item !== 'money' & strg_dt[i].item !== 'gold') {
            ...
            if (durabilityValue !== 0) {
                data_storage_Html += '<div class="item" data-content="'+strg_dt[i].label+'"><div id="'+ i +'" class="item-content" ondblclick="transfer_from_storage()" onMouseOver="change_name_other('+ i +')" ><img src="images/items/' + strg_dt[i].item + '.png" width="90" height="90"  id="item"><progress id="progress" max="100" value="'+durabilityValue+'">TEST</progress><div class="bottom-right" id="count_'+i+'">'+ strg_dt[i].count +'</br>'+ Math.round(weight_item * 100) / 100 + ' kg</div></div></div>'
            } else {
                var image_url = 'nui://gum_inventory/html/images/items/' + strg_dt[i].item + '.png';
                if (doesFileExist(image_url) == "yes") {
                    data_storage_Html += '<div class="item" data-content="'+strg_dt[i].label+'"><div id="'+ i +'" class="item-content" ondblclick="transfer_from_storage()" onMouseOver="change_name_other('+ i +')" ><img src="images/items/' + strg_dt[i].item + '.png" width="90" height="90"  id="item"><div class="bottom-right" id="count_'+i+'">'+ strg_dt[i].count +'</br>'+ Math.round(weight_item * 100) / 100 + ' kg</div></div></div>'
                } else {
                    data_storage_Html += '<div class="item" data-content="'+strg_dt[i].label+'"><div id="'+ i +'" class="item-content" ondblclick="transfer_from_storage()" onMouseOver="change_name_other('+ i +')" ><img src="images/items/badItem.png" width="90" height="90"  id="item"><div class="bottom-right" id="count_'+i+'">'+ strg_dt[i].count +'</br>'+ Math.round(weight_item * 100) / 100 + ' kg</div></div></div>'
                }
            }
        } 
    }
    ...
    for (var i in strg_dt) {
        if (strg_dt[i].weapon == true & strg_dt[i].item !== 'money' & strg_dt[i].item !== 'gold'){
            ...
            data_storage_Html += '<div class="item" data-content="'+strg_dt[i].label+'"><div id="'+ i +'" class="item-content"  ondblclick="transfer_from_storage()" onMouseOver="change_name_other('+ i +')" ><img src="images/items/' + strg_dt[i].count + '.png" width="90" height="90"  id="item"></div></div>'
        }
    }
...
function dragElement(elmnt) {
  ...
  dragElement2(document.getElementById("header_container"));
  let container2 = document.getElementById('container_other')
  ...
  function dragElement2(elmnt) {
    ...
    function elementDrag2(e) {
      ...
      pos3 = e.clientX;
      pos4 = e.clientY;
      container2.style.top = (container2.offsetTop - pos2) + "px";
      container2.style.left = (container2.offsetLeft - pos1) + "px";
    }
  ...
  dragElement3(document.getElementById("input_text"));
  let container3 = document.getElementById('input_data')
  ...
  function dragElement3(elmnt) {
    ...
    function elementDrag(e) {
      ...
      pos3 = e.clientX;
      pos4 = e.clientY;
      container3.style.top = (container3.offsetTop - pos2) + "px";
      container3.style.left = (container3.offsetLeft - pos1) + "px";
    }
